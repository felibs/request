...
export async function asynchronousExecuter(fnList: Array<execItem>): Promise<execResult> {
    let result: execResult = { data: null, error: null }
...
export async function executer(fnList: Array<execItem>, type: execType = execType.async): Promise<execResult>{
    let result: execResult = { data: null, error: null }
